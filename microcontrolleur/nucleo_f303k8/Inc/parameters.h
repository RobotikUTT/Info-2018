...
#define ENC_RESOLUTION 2048 //resolution du codeur
...
#define ENTRAXE_ENC 215.5 //(201.35)REGLE PAR TES - Distance entre chaque roue codeuse en mm (202.37), base 200,8
