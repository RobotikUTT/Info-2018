...
#define ENC_RIGHT_RADIUS 26 //REGLE PAR TEST - rayon de la roue codeuse (31.24)
#define ENTRAXE_ENC 220 //(201.35)REGLE PAR TES - Distance entre chaque roue codeuse en mm (202.37), base 200,8
